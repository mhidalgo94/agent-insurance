...
import { title, card } from './motion-styles';
      ...
      <header className="header">
        ...
        <div className="overlay">
          <div className='text-overlay'>
            <motion.h1 initial={title.initial} whileInView= {title.animate} className='title is-1'>Welcome, I'm Leo Fernandez.</motion.h1>
            {/* <h1 className='title is-1'>Hi 👋, I'm Leo Fernandez.</h1> */}
            <motion.p className='subtitle is-5 mt-2' initial={title.initial} whileInView= {title.animate}>Discover expert insurance solutions tailored to your medical needs.<br/> Your health, our priority.</motion.p>
            <div className='cards-headers'>
            <div className="columns is-multiline" >
              <div className="column is-one-third"  style={{border:"none"}}>
                <motion.div initial={card.initial} whileInView={card.animate} className='card'>
                  <div className="card-content">
                    <span className='icon-card' >
                      <svg width="30" height="30" aria-hidden="true" focusable="false"  data-icon="user-shield" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512">
