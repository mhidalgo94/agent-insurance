                ...
                <div className='card'>
                  <div className="card-content">
                    <span className='icon-card' >
                      <svg width="30" height="30" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="user-shield" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512">
